...
from meltingpot.python.utils.policies.rule_adjusting_policy import ROLE_SPRITE_DICT, APPLE_RESPAWN_RADIUS, REGROWTH_PROBABILITIES, OBSERVATION_RADIUS, REMOVE_HIT_PLAYER, PENALTY_FOR_BEING_ZAPPED, THRESHOLD_APPLE_DEPLETION, DEFAULT_MAX_LIFE_SPAN, THRESHOLD_APPLE_RESTAURATION, INT_TO_ROLE, ROLE_TO_INT
...
W      P     <~Sf  P  W
W          P <~S>     W
WT^A^T^T^T^T^;~S^T^A^TW
W_AAA_____________AAA_W
WAAAAA_____A_____AAAAAW
W_AAA_____AAA_____AAA_W
W__A_____AAAAA_____A__W
W_____A___AAA___A_____W
W_Q__AAA___A___AAA__G_W
W___AAAAA_____AAAAA___W
W____AAA____Q__AAA____W
W__G__A___Q_____A__G__W
WWWWWWWWWWWWWWWWWWWWWWW
WD-----WD-----WD------W
WWWWWWWWWWWWWWWWWWWWWWW
WD-----WD-----WD------W
