...
SUBSTRATES: Set[str] = frozenset({
    ...
    'commons_harvest_territory_pollution',
    'commons_harvest_territory_pollution__wo_territory',
    'commons_harvest_territory_pollution__wo_pollution',
    'commons_harvest_territory_pollution__wo_territory_pollution',
    'coop_mining',
    'daycare',
