...
def get_config(
    substrate_name: str = "commons_harvest_territory_pollution",
  ...
  # Number of arenas.
  # This is called num_rollout_workers in ray version 2.2.0.
  ...
  # https://docs.ray.io/en/latest/rllib-models.html#t-in-models. It is
